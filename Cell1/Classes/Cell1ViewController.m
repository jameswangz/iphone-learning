...
- (void)viewDidLoad {
	NSDictionary *row1 = [[NSDictionary alloc] initWithObjectsAndKeys: @"MacBookMacBookMacBookMacBookMacBookMacBookMacBookMacBookMacBookMacBookMacBookMacBook", @"Name", @"White", @"Color", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (cell == nil) { 
		...
		CGRect nameValueRect = CGRectMake(80, 5, 800, 15); 
